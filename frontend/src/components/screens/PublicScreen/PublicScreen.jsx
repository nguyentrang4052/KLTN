...
function PublicScreen() {
  ...
  const categories = [
    { name: 'Tất cả', count: '50,847' },
    { name: '💻 IT/Tech', count: '15,200' },
    { name: '📊 Marketing', count: '6,400' },
    { name: '💰 Tài chính', count: '4,800' },
    { name: '🎨 Design', count: '3,200' },
    { name: '🏢 Quản lý', count: '2,100' },
    { name: '🏠 Remote', count: '8,920' }
  ];
