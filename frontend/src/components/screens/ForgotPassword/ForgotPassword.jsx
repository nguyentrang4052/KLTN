...
export default function ForgotPassword({ onGoLogin }) {
  ...
  const handleVerifyOTP = async () => {
    ...
    setLoading(true)
    // TODO: POST /api/auth/verify-otp → { email, otp: otp.join('') }
  ...
  const handleResetPw = async () => {
    ...
    setLoading(true)
    // TODO: POST /api/auth/reset-password → { email, otp: otp.join(''), newPassword: newPw }
    await new Promise(r => setTimeout(r, 1200))
    setLoading(false)
    setStep(4)
  }
              ...
              <div className="fp-form">
                ...
                <p className="fp-resend">
                  ...
                  {resendTimer > 0
                    ...
                    : <a onClick={() => { startResend(); handleSendOTP() }}>Gửi lại</a>
                  }
                </p>
              </div>
            </>
